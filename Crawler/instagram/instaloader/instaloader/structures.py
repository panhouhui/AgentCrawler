...
class Profile:
    ...
    def from_username(cls, context: InstaloaderContext, username: str):
        ...
        try:
            data = context.web_profile_info(username.lower()).get("data")
    ...
    def from_id(cls, context: InstaloaderContext, profile_id: int):
        ...
        try:
            user = context.web_user_info(profile_id).get('user')
        except QueryReturnedNotFoundException:
            user = None
        ...
        try:
            if not self._has_full_metadata:
                if not self._context.is_logged_in:
                    ...
                    # profile query.
                    try:
                        data = self._context.web_profile_info(self.username).get('data')
